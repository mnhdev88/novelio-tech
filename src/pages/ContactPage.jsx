...
import { COMPANY, PHONE_TEL, WHATSAPP_URL } from '../data/siteData';
        ...
        <div className="container-xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              ...
              { icon: MessageCircle, label: 'WhatsApp', value: 'Chat with us 24/7', sub: 'Instant response', href: WHATSAPP_URL, color: 'from-[#128C7E] to-[#25D366]' },
