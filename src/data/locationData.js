export const CITIES = [
  {
    ...
    painPoints: [
      ...
      { title: 'No Lead System', desc: "Traffic without conversion is just noise. Austin's market is too competitive to leave leads uncaptured." },
    ],
    stats: [
      { value: '978K+', label: 'Population' },
      { value: '30K+', label: 'Small Businesses' },
      { value: '#1', label: 'Fastest Growing City' },
      { value: '42%', label: 'Avg Lead Growth' },
    ],
    testimonial: {
      ...
      name: 'Mike R.',
      role: 'Owner',
      company: 'Plumbing Business, TX',
      result: '+42% local calls in 60 days',
    },
    faqs: [
      {
        q: 'How long does SEO take for a small business in Austin?',
        a: "For most Austin businesses, you'll see measurable improvements in local visibility within 60–90 days. Full organic rankings for competitive keywords typically take 4–6 months. Google Business Profile optimizations often show results within 30 days.",
      },
      {
      ...
      },
      {
        ...
        a: 'Yes. Google Maps (Local Pack) ranking is one of our core services. We optimize your Google Business Profile, build local citations, and implement location-specific SEO strategies proven to improve map visibility.',
      },
      {
  ...
  },
  {
    ...
    stats: [
      ...
      { value: '70K+', label: 'Small Businesses' },
      { value: '#4', label: 'Largest US City' },
    ...
    faqs: [
      {
        q: 'How can my Houston business rank higher on Google?',
        a: "Ranking in Houston requires a combination of technical SEO, local citation building, Google Business Profile optimization, and location-specific content. We build a full local SEO strategy tailored to Houston's competitive landscape.",
      },
      {
      ...
      },
      {
        ...
        a: 'Local SEO improvements typically show within 60–90 days. Paid campaigns can drive traffic within 48 hours. We set clear KPIs from day one so you always know what to expect.',
      },
      {
        q: 'Does Novelio provide website design for Houston small businesses?',
        a: 'Yes. We design and build custom, conversion-optimized websites for Houston businesses. Every site is fast-loading, mobile-responsive, and built to rank on Google from launch day.',
      },
    ],
  },
  {
    ...
    stats: [
      ...
      { value: '200K+', label: 'Registered Businesses' },
      { value: '#1', label: 'FL Business Hub' },
      { value: '3×', label: 'Avg Visibility Lift' },
    ],
    testimonial: {
      quote: "Novelio found three critical gaps in our Google listing we never even knew about. Within 60 days we were getting 42% more calls from local search. Best investment we've made.",
      name: 'Mike R.',
      role: 'Owner',
      company: 'Service Business, FL',
      result: '+42% local calls in 60 days',
    },
    faqs: [
      {
        q: 'How can my Miami business show up on Google Maps?',
        a: "Google Maps visibility (the Local Pack) is driven by your Google Business Profile optimization, local citations, and review signals. We handle all three with a strategy built specifically for Miami's competitive market.",
      },
      {
      ...
      },
      {
        ...
        a: 'We serve Miami businesses across hospitality, retail, real estate, healthcare, professional services, and more. Our strategies are tailored to your specific market and industry competition.',
      },
    ],
  },
  {
    ...
    painPoints: [
      ...
      { title: 'Leaky Lead Pipeline', desc: "Tampa's growing customer base is searching online daily. Without a lead capture system, you're sending traffic straight to your competitors." },
    ],
    stats: [
      { value: '409K+', label: 'Population' },
      { value: '55K+', label: 'Small Businesses' },
      { value: 'Top 5', label: 'SE Growth Cities' },
    ...
    faqs: [
      {
        q: 'How can Tampa small businesses compete with large chains on Google?',
        a: 'Hyper-local SEO is the equalizer. By targeting Tampa neighborhood keywords, optimizing your Google Business Profile, and building local citations, small businesses consistently outrank national chains in local search results.',
      },
      {
      ...
      },
      {
        ...
        a: 'Yes. Local SEO is one of our core services for Tampa businesses. We optimize Google Business Profiles, build local citations, create Tampa-specific content, and track rankings monthly.',
      },
      {
        q: 'How quickly can I see results from SEO in Tampa?',
        a: 'Google Business Profile optimizations often show results in 30–45 days. Organic SEO rankings typically improve meaningfully within 60–90 days, with significant results at 4–6 months.',
      },
    ],
  },
  {
    ...
    stats: [
      { value: '311K+', label: 'Population' },
      { value: '8,000+', label: 'Small Businesses' },
      { value: '23%', label: 'Local Businesses on Google Page 1' },
    ...
    testimonial: {
      ...
      result: 'Daily online bookings within 45 days',
    },
    faqs: [
      {
        q: 'How much does a website cost for a Newark NJ small business?',
        a: "Novelio builds a fully functional demo website for your Newark business at no cost — you see the finished site before any payment is discussed. Our packages start at $600 for a complete, SEO-ready website. There are no hidden fees and no long-term contracts.",
      },
      {
        q: 'How long does it take to build a business website in Newark?',
        a: 'Your demo website is ready within 48–72 hours of your initial call. Once you approve it, the full live site goes live within 5–7 business days. Domain setup and hosting are included in the process.',
      },
      {
  ...
  },
  {
    ...
    stats: [
      ...
      { value: 'Top 10', label: 'Best US Business City' },
    ...
    testimonial: {
      ...
      name: 'Mike R.',
      role: 'Owner',
      company: 'Service Business, CO',
      result: '+42% local calls in 60 days',
    },
    faqs: [
      {
        q: 'How long does SEO take for a small business in Denver?',
        a: 'Google Business Profile optimizations show results in 30–45 days. Organic page rankings typically improve within 60–90 days, with top-10 placements for city-specific keywords usually achieved within 4–6 months.',
      },
      {
      ...
      },
      {
        ...
        a: 'Google Maps rankings are driven by your GBP completeness, reviews, local citations, and proximity signals. We build a complete local SEO strategy that systematically improves your Maps visibility over 60–90 days.',
      },
      {
        q: 'Does Novelio work with Denver tech companies and startups?',
        a: 'Yes. We work with Denver tech startups, SaaS companies, and established businesses alike. Our growth strategies are fully customizable to your growth stage, budget, and market.',
      },
    ],
  },
];
...
export const STATES = [
  ...
  },
  {
    ...
    stateSlug: 'florida',
    stateCode: 'FL',
    description: 'Helping Florida small businesses dominate local search from Miami to Tampa and Orlando.',
  ...
  },
  {
    ...
    stateSlug: 'colorado',
    stateCode: 'CO',
    description: 'Growing Denver and Colorado businesses with AI-powered digital strategies.',
    gradient: 'from-emerald-500 to-[#1D4ED8]',
    cities: ['denver'],
  },
  {
    state: 'New Jersey',
    stateSlug: 'new-jersey',
    stateCode: 'NJ',
    description: 'Helping Newark and New Jersey small businesses dominate local search and book more clients online.',
    gradient: 'from-[#6B3FA0] to-[#0EA5E9]',
    cities: ['newark'],
  },
];

export function getCityData(stateSlug, citySlug) {
  return CITIES.find(c => c.stateSlug === stateSlug && c.citySlug === citySlug) || null;
}

export function getStateData(stateSlug) {
  return STATES.find(s => s.stateSlug === stateSlug) || null;
}
